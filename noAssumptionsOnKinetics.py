...
#multicompartmental SIRD model where there are no conditions on the kinetic
#functions (they may not be constant and they may depend upon the 
#entire system state). Code may be unstable for very small propensities
